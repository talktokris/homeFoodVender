...
const validationSchema = Yup.object().shape({
  name: Yup.string().required().min(2).label("Title"),
  location_lebel: Yup.string().required().min(2).label("Location"),
...
function ProfileScreen({ route, navigation }) {
  ...
  const userData = route.params.vender;
        ...
        <Screen>
          <View style={styles.container}>
            <AppForm
              initialValues={{
                name: userData.name,
                location_lebel: userData.location_lebel,
